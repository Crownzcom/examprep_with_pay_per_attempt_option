                        ...
                        {subjectName === "English-Language" && category.category >= 51 && category.category <= 55 ? (
                            ...
                            <div>  
                                ...
                                <div style={{
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: category.markedHTML }} />
                                </div>
...
//             // If this was the user's answer, mark it visually
//             if (input.hasAttribute('checked') || input.checked) {
//                 // Add visual indication this was the user's selection
//                 const parentLabel = input.closest('label');
//                 if (parentLabel) {
//                     parentLabel.style.fontWeight = 'bold';
//                     parentLabel.style.backgroundColor = '#f0f8ff'; // Light blue background
//                     parentLabel.style.padding = '3px';
//                     parentLabel.style.display = 'block';
//                     parentLabel.style.margin = '3px 0';
//                     parentLabel.style.borderLeft = '3px solid #4285f4';
//                 }
//             }
//         });
...
//                 // Set the value of the input to show what the user typed
//                 if (userAnswer) {
//                     input.value = userAnswer;
//                     // Style it to make it clear this was the user's input
