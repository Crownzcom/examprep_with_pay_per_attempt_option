...
const sentences = [
  `MY PLANS AFTER PRIMARY LEAVING EXAMINATION.`,
  `I just finished my Primary Leaving Examination, and I want to say a big thank you to my head teacher and teachers for helping me.`,
  `They are the best!`,
  `I hope I get good grades in my PLE, and that will make my family and teachers really happy.`,
  `After I know my grades, I'm going to help my mom and dad at home.`,
  `I want to make their work easier because they helped me a lot.`,
  `When I get my results, I'm going to have a big party with my family and friends.`,
  `We will laugh and be happy because I finished primary school.`,
  `In the future, I will talk to my family about what school to go to next.`,
  `In short, after my PLE, I will thank my teachers, have a fun party, help at home, and plan for more school.`,
];
...
function evaluateAllAnswers() {
  ...
  if (!allCorrect || userOrder.length === 0) {
    showCorrectOrder();
  }
