...
const sentences = [
  ...
  `P.O. Box 1 Kiddo`,
  `Dear Sir,`,
  `RE: REQUEST TO RETURN TO SCHOOL.`,
  `I am writing to you in regard to the desk that 1 broke last Friday.`,
  `I would like to deliver my sincere apology for the incident.`,
  `It happened because I was excited over my good performance in the previous test.`,
  `I am very sorry for that madam.`,
  `For that matter madam, I am kindly requesting for forgiveness and permission to return to school.`,
  `I promise to be a good boy from today onwards and I also promise that I will never break school desks again.`,
  `I hope my sincere request will be granted I will be very happy to return to school.`,
  `Thank you.`,
  `Yours sincerely,`,
  `${userName}`,
  `Primary Seven`,
