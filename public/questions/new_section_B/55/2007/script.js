...
const sentences = [
  "They should also give them all their parental care.",
  "Perhaps the best would be unity is strength.",
  "Finally, the children themselves must be highly disciplined.",
  "What makes some children do well in their examination?",
  "In addition, they must be obedient to both their parents and teachers.",
  "First of all, the parents must play their part well.",
  "Secondly, the teachers must teach them well.",
  "This is really a very difficult question to answer.",
  "They must always mark their books properly.",
  "This is by sending their children to school.",
];
