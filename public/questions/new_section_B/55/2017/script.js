...
const sentences = [
  ...
  `${schoolName},`,
  `${schLoc},`,
  `Dear Mr. Kalema James,`,
  `I am writing to apologize for accidentally breaking a windowpane during lunchtime while playing with a friend in the classroom.`,
  `It was a thoughtless act, and I deeply regret it.`,
  `I understand the importance of respecting school property.`,
  `I have already spoken to my parents about the incident, and they will replace the windowpane promptly.`,
  `I assure you that I will never play in the classroom again, and I have learned my lesson about the consequences of my actions.`,
  `I am truly sorry for any inconvenience this has caused and promise to be a more responsible student in the future.`,
