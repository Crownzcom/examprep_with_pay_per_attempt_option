...
const sentences = [
  "Others greet by hugging or shaking hands.",
  "Apart from language, it has cultural beliefs and customs.",
  "The children born from these intermarriages pick from the two cultural backgrounds.",
  "However, most of our cultural beliefs and customs are changing.",
  "There are many tribes in Uganda.",
  "In future, Uganda might end up with a new breed of mixed cultures.",
  "When it comes to dressing, the customs also vary a lot.",
  "This is so due to intermarriages.",
  "Each tribe speaks a different language.",
  "Some customs require children and women to kneel while greeting.",
];
