...
const sentences = [
  `St. Lambert Primary School`,
  `P.O. Box 121`,
  `Mukono, Uganda`,
  `${currentDate}`,
  `Dear Mary Napeyok,`,
  `How are you? Thank you for the letter you wrote to me. I have just received it.`,
  `I am requesting you to visit me in Kampala during Christmas holidays.`,
  `During this I shall take you to the Zoo and the biggest market in Kampala.`,
  `We shall also visit the Museum.`,
  `Greet all your people. God bless you.`,
  `Your Friend`,
  `${userName}`,
];
...
function createDroppedSentence(sentence, index) {
  ...
  if (
    sentence === `St. Lambert Primary School` ||
    sentence === `P.O. Box 121` ||
    sentence === `Mukono, Uganda` ||
