...
const sentences = [
  ...
  `${currentDate}`,
  `The head teacher,`,
  `Rock High Secondary School,`,
  `P O Box 222,Tororo`,
  `Dear Sir/Madam`,
  `RE: APPLICATION FOR A VACANCY IN SENIOR ONE.`,
  `I Wish to apply for a vacancy in you school in senior one next term.`,
  `I am a boy aged fourteen years. I passed Primary Leaving Examination in Division one.`,
  `In my former primary school, I was a Prefect in charge of sports.`,
