...
const sentences = [
  "The third man asked the driver to stop.",
  "It started crying until everybody became concerned.",
  "I sat next to a woman who had a baby.",
  "Another one asked whether the baby was hers.",
  "Last Sunday, I took a taxi to the village.",
  "When the taxi stopped, the woman could not explain why she was not breastfeeding the baby.",
  "As we approached Kagadi, the baby woke up.",
  "One of the men asked her why she could not breastfeed the baby.",
  "The baby was asleep.",
  "People asked the taxi driver to drive to the nearest police station.",
];
