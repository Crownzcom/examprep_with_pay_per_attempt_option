...
const sentences = [
  "I think, we can fight it by seriously using our life skills.",
  "Thirdly, it has made them exposed to diseases, like AIDS.",
  "In the end, we shall get rid of poverty in our country.",
  "There are many problems facing people in the world today.",
  "First of all, it has made them fail to get good education.",
  "These skills will help us to work very hard.",
  "This has made a lot of Ugandans commit many evils.",
  "What shall we do to fight this great difficulty?",
  "In Uganda, like in some other countries, people face a problem of poverty.",
  "Secondly, it has led them to being idle.",
];
